            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">Our Service(s)</h3>
                        </div>
                    ...
                    <table class="table align-items-center table-flush">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col">Acceptance Code</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="td_content">{{ $user->Add_one ?? '-'            }}</td>
                                <td class="td_content">{{ $user->Add_two ?? '-'            }}</td>

                                {{-- Action --}}
                                <td class="text-right">
                                    <div class="dropdown">manage_users.view
