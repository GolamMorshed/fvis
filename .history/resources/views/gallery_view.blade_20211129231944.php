                    ...
                    <table class="table align-items-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src={{ asset('images/'.$gal->image) }} alt="No Image!" style="width:40px; height:40px;" class="rounded-circle"></td>
                                @if($gal->status == 1)
                                <td>
                                ...
                                <td class="text-right">
                                    <div class="dropdown">
                                        <a class="btn btn-sm btn-icon text-light" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
