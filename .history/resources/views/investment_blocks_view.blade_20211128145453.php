            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">Our Partner(s)</h3>
                        </div>
                    ...
                    <table class="table align-items-center table-flush">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col">1 Time Investors Introduction Fee</th>
                                <th scope="col">Invesment Monthly Income</th>
                                <th scope="col">Lock in Period</th>
                                <th scope="col">Extension Option</th>
                                <th scope="col">Status</th>
                                <th scope="col">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($blocks as $partner)
                            <tr>
                                <td>{{ $partner->id                     }}</td>
                                <td>{{ $partner->Name                  }}</td>
                                <td>{{ $partner->Currency ?? '-'   }}</td>
                                <td>{{ $partner->Price ?? '-'         }}</td>
                                <td>{{ $partner->discription ?? '-' }}</td>
                                <td>{{ $partner->offers ?? '-'            }}</td>
                                <td>{{ $partner->one_time_investors_introduction_fee ?? '-'          }}</td>
                                <td>{{ $partner->investment_monthly_income ?? '-'          }}</td>
                                <td>{{ $partner->lock_in_period ?? '-'          }}</td>
                                <td>{{ $partner->extension_period ?? '-'          }}</td>
