                    ...
                    <table class="table align-items-center table-flush">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col">Chinese Content</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $project->id                         }}</td>
                                <td>{{ $project->title                      }}</td>
                                <td>{{ $project->chinese_title ?? '-'       }}</td>
                                <td style="display: block; width: 100px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">{{ $project->content ?? '-'             }}</td>
                                <td>{{ $project->chinese_content ?? '-'     }}</td>
                                <td>{{ $project->image ?? '-'               }}</td>
