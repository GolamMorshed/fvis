                    ...
                    <div class="card-body">
                        <form method="post" action="{{url('gallery-edit/'.$gallery[0]->id)}}" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <button type="button" class="btn btn-warning" data-container="body" data-toggle="popup" data-color="warning" data-placement="top" data-content="This is a very beautiful popover, show some love.">
                                    Warning popover
                                  </button>
                                ...
                                <div class="form-group{{ $errors->has('status') ? ' has-danger' : '' }}">
                                    ...
                                    <td class="text-center">
                                        <label class="custom-toggle">
                                            <input type="checkbox" checked name="status" id="input-status">
                                            <span class="custom-toggle-slider rounded-circle"></span>
                                        </label>
                                    </td>
                                    @elseif($gallery[0]->status == 0)
                                    <td class="text-center">
                                        <label class="custom-toggle">
