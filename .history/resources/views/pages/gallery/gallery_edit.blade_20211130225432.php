                        ...
                        <form method="post" action="{{url('gallery-edit/'.$gallery[0]->id)}}" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('image') ? ' has-danger' : '' }}">
                                    ...
                                    <input hidden type="text" name="old-name" id="old-name" value="{{ $gallery[0]->image }}" class="form-control form-control-alternative{{ $errors->has('old-image') ? ' is-invalid' : '' }}" placeholder="{{ __('Image') }}"> 
                                    <br>
