                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                            ...
                                            <a class="btn btn-danger" role="button" data-toggle="modal" data-target="#modal-delete-{{ $gal->id }}">Delete
                                        </div>
                                    </div>
                                </td>
                            </tr>

                            <div class="modal fade" id="modal-delete-{{ $gal->id }}" tabIndex="-1">   

                                <form method="POST" action="{{ route('court.destroy', $gal->id) }}">
