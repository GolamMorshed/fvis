                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                            ...
                                            <a class="dropdown-item" data-toggle="modal" data-id="{{$gal->id}}" data-target="#deleteDialog">Delete</a>
                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#deleteDialog" data-myvalue="{{$lesson->title}}" data-myvar="{{$lesson->id}}">
                                                Start lesson
                                            </button>
                                        </div>
                                    </div>
    ...
    <script src="//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js">
        ...
        $('#deleteDialog').on('click', function (e) {
            ...
            ATTRIBUTES.forEach(function (attributeName) {
                ...
                var $modalAttribute = $(modalSelector + ' #modal-id');
