                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                            ...
                                            <!-- Delete method -->
                                            <a href="#" style="color:black; font-weight: bold;" data-href="{{ url('/deletestory', $gal->id) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="Delete">Delete</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
