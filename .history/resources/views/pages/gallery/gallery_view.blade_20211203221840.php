...
<script type="module" src="appthatimports.js">
    export default {
        mounted() {
            this.fetchGallery();
        },
        ...
        methods:{
            fetchGallery() {
                axios.get('http://localhost:8000/api/gallery_view')
                .then(res => {
                    this.list = res.data;
    ...
    {{-- <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js">
        $.ajax({
            ...
            url: 'http://localhost:8000/api/gallery/view',
            type: 'get',
            dataType: 'JSON',
            success: function(response){
                ...
                for(var i=0; i<len; i++){
                    ...
                    var chinese_title = response[i].chinese_title;
