                        ...
                        <form method="post" action="{{url('gallery-edit/'.$gallery[0]->id)}}" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('chinese_title') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="chinesetitle" id="input-chinese-title" value="{{ $gallery[0]->chinese_title }}" class="form-control form-control-alternative{{ $errors->has('chinese-title') ? ' is-invalid' : '' }}" placeholder="{{ __('Chinese Title') }}">
