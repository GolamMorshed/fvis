                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                            ...
                                            <a class="dropdown-item" class="btn-text" data-toggle="modal" data-target="#exampleModal">
                                                <button type="button" class="btn-text" data-toggle="modal" data-target="#exampleModal">
                                                Launch demo modal
                                              </button></a>
                                        </div>
                                    </div>
