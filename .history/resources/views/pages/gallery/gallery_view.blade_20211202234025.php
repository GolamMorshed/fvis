                    ...
                    <table class="table align-items-center table-flush">
                        ...
                        <tbody>
                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                            ...
                                            <a class="dropdown-item" data-toggle="modal" data-myvalue="{{$gal->id}}" data-target="#deleteDialog">Delete</a>
                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#deleteDialog" data-myvalue="{{$gal->id}}">
                                                Start lesson
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <a class="btn btn-danger" role="button" data-toggle="modal" data-target="#modal-delete-{{ $court->id }}">Delete
                                ...
                                <div class="modal fade" id="modal-delete-{{ $court->id }}" tabIndex="-1">
                            @endforeach
                        </tbody>
                    </table>
                </div>
