                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                            ...
                                            <a class="dropdown-item" data-toggle="modal" data-id="{{$gal->id}}" href="#exampleModal" data-target="#exampleModal">Delete</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                                ...
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <h5 class="modal-title" id="exampleModalLabel">We just want to confirm...</h5>
                                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                      </button>
                                    </div>
                                    <div class="modal-body">
                                      <form action="{{ url('gallery-update/'.$gal->id) }}" method="POST" id="deleteFormClient">
                                        @csrf
                                        @method('DELETE')
                                    ...
                                    <div class="modal-footer">
                                      ...
                                      <button type="submit" data-id="47" class="btn btn-danger">Delete</button>
                                    </form>
                                    </div>
                                  </div>
                                </div>
...
<div class="col-xl-6">
    ...
    <script>
        $(document).on('click', '.delete', function(e) {
            ...
            alert(id);
            $('#deleteFormClient').attr('action', {{ url('gallery-delete/' + id ) }});
        });
    </script>
