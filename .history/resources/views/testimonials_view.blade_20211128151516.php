                    ...
                    <table class="table align-items-center table-flush">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="td_content">{{ $testimonial->review ?? '-'             }}</td>
                                <td>{{ $testimonial->chinese_name ?? '-'               }}</td>
                                <td>{{ $testimonial->chinese_company_name ?? '-'              }}</td>
                                <td class="td_content">{{ $testimonial->chinese_review ?? '-'     }}</td>
