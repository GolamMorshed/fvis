            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">Our Project(s)</h3>
                        </div>
                    ...
                    <table class="table align-items-center table-flush">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col">Annual Plan Fee</th>
                                <th scope="col">Investment</th>
                                <th scope="col">Investment Duration</th>
                                <th scope="col">Monthly Fixed Income</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $request->plan_fee}}</td>
                                <td>{{ $request->annual_plan_fee}}</td>
                                <td>{{ $request->investment}}</td>
                                <td>{{ $request->investment_duration }}</td>
                                <td>{{ $request->monthly_fixed_income }}</td>
                                <td>{{ $request->plan_status }} </td>
