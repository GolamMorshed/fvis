...
Route::get('membership-plans-records', ['as' => 'membership_plans.view', 'uses' => 'App\Http\Controllers\MembershipController@index_plans']);
Route::get('membership-request-records', ['as' => 'membership_requests.view', 'uses' => 'App\Http\Controllers\MembershipController@index_requests']);