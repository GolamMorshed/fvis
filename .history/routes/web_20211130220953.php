...
Route::get('gallery-update', ['as' => 'gallery.update/{id}', 'uses' => 'App\Http\Controllers\GalleryController@edit_view']); // VIEW EDIT INTERFACE
Route::put('gallery-edit', ['as' => 'gallery.edit/{id}', 'uses' => 'App\Http\Controllers\GalleryController@edit']); // EDIT DATA
