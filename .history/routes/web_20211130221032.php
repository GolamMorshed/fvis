...
Route::get('gallery-update/{id}', ['as' => 'gallery.update', 'uses' => 'App\Http\Controllers\GalleryController@edit_view']); // VIEW EDIT INTERFACE
Route::put('gallery-edit/{id}', ['as' => 'gallery.edit', 'uses' => 'App\Http\Controllers\GalleryController@edit']); // EDIT DATA
