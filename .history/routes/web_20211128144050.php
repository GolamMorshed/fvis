...
Route::get('users-records', ['as' => 'cms_pages.view', 'uses' => 'App\Http\Controllers\PageController@index_page']);
Route::get('users-records', ['as' => 'investment_blocks.view', 'uses' => 'App\Http\Controllers\PageController@index_block']);
Route::get('users-records', ['as' => 'benefit_cars.view', 'uses' => 'App\Http\Controllers\PageController@index_car']);