...
Route::get('gallery-update/{id}', ['as' => 'gallery.update', 'uses' => 'App\Http\Controllers\GalleryController@add_view']); // VIEW ADD INTERFACE
Route::put('gallery-edit', ['as' => 'gallery.store', 'uses' => 'App\Http\Controllers\GalleryController@store']); // ADD NEW DATA
