...
Route::get('gallery-update/{id}', ['uses' =>'App\Http\Controllers\GalleryController@edit_view']); // VIEW EDIT INTERFACE
Route::put('gallery-edit/{id}', ['uses' =>'App\Http\Controllers\GalleryController@edit']); // EDIT DATA
Route::put('gallery-delete/{id}/{image}', ['uses' =>'App\Http\Controllers\GalleryController@delete']); // DELETE DATA
