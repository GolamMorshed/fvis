...
Route::get('users-records', ['as' => 'manage_users.view', 'uses' => 'App\Http\Controllers\PageController@index_page']);
Route::get('users-records', ['as' => 'manage_users.view', 'uses' => 'App\Http\Controllers\PageController@index_block']);
