...
Route::get('gallery-add', ['as' => 'gallery.add', 'uses' => 'App\Http\Controllers\GalleryController@add']);
Route::get('gallery-store', ['as' => 'gallery.store', 'uses' => 'App\Http\Controllers\GalleryController@store']);
