...
Route::get('gallery-update/{id}', ['as' => 'gallery.update', 'uses' => 'App\Http\Controllers\GalleryController@edit_view']); // VIEW ADD INTERFACE
Route::put('gallery-edit', ['as' => 'gallery.edit', 'uses' => 'App\Http\Controllers\GalleryController@store']); // ADD NEW DATA
