...
Route::get('gallery-update/{id}', [App\Http\Controllers\GalleryController::class, 'edit_view']); // VIEW EDIT INTERFACE
Route::put('gallery-edit/{id}', ['as' => 'gallery.edit/{id{', 'uses' => 'App\Http\Controllers\GalleryController@store']); // EDIT DATA
