...
Route::get('gallery-add', ['as' => 'gallery.add', 'uses' => 'App\Http\Controllers\GalleryController@add']); // VIEW ADD INTERFACE
Route::put('gallery-store', ['as' => 'gallery.store', 'uses' => 'App\Http\Controllers\GalleryController@store']);
