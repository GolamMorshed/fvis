                    ...
                    <table class="table align-items-center table-flush">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $block->Price ?? '-'         }}</td>
                                <td>{{ $block->discription ?? '-' }}</td>
                                <td>{{ $block->offers ?? '-'            }}</td>
                                <td>{{ $block->one_time_investors_introduction_fee ?? '-'          }}</td>
                                <td>{{ $block->investment_monthly_income ?? '-'          }}</td>
                                <td>{{ $block->lock_in_period ?? '-'          }}</td>
                                <td>{{ $block->extension_period ?? '-'          }}</td>
                                <td>{{ $block->Status ?? '-'          }}</td>
